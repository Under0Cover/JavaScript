...
*/
 ...
 //  Ele é usado para combinar arrays
 const combinar = [...vogais, ...consoantes]
 console.log(combinar)
 
 // Ele pode ser usado para combinar e adicionar elementos
 const mais_elementos = [...vogais, 'w', ...consoantes]
 console.log(mais_elementos)
 
 // Ele pode ser usado para combinar e adicionar elementos em vários elementos
 combinar_final = [...vogais, ...consoantes, 'y']
 console.log(combinar_final)
 
 // Ele pode ser usado para clonar um array
 clonado = [...combinar_final]
 console.log(clonado)
 ...
 // Combinação com array
 const lista_ponto = lista.join('.')
 console.log(lista_ponto)
 
 // Separação de array
 
const frase = "Oi bem vindo ao meu GitHub"
const picado = frase.split(' ')
console.log(picado)
 
 // Fazendo o slug
 const slug = picado.join('-')
 console.log(slug)
